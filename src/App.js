...
const loop = [
  {  //count 0
    text: `In first-world countries such as the United States, children can gain an education without much question and generally have to worry little of issues such as human trafficking. However, many children across the globe are out of school due to various reasons, including social factors, child marriage, distance to school, wars/conflicts, modern slavery, extreme poverty, and violence at or on the way to school.
  Getting an education allows people to better provide for their families when they are older and live healthier, more stable lives. When paid a stable income, people can better support their local communities and contribute to the economic prosperity of their entire nation. Educated people are also more likely start businesses and generate jobs. Global education can even help to combat overpopulation and climate change.
...
,
  ...
  {  //count 2
    text: `The next day you arrive at Kathmandu, the capital city of Nepal. When you arrive at your new master’s house, however, you receive no warm welcome. The first day you arrive, your master orders you conduct several tedious tasks such as cleaning their house, washing their dishes, and caring for his children. That day you are not allowed to stop working until midnight.
  Having hoped that the following days would be less tiresome, you are disappointed to find that your long sessions of labor will not be ending any time soon. Most days you end up working from dawn to dusk and are subject to complete control by your master, of which he frequently takes advantage and abuses you physically and emotionally. The thought of going to school has hardly passed your mind, for your master lied about possibly sending you to a local school. In fact, you are kept completely isolated in your master’s house because he doesn’t want to risk prosecution for keeping a kamlari. You’re uncertain if you will even be able to reunite with your family at the Maghe Festival the following year.
  ...
  {  //count 3
    text: `You decide to make plans to escape your current life as a slave and find your way back to your village. You’ve recently discovered that there is another bonded Kamlari living in a house close to yours, and there have been a few opportunities to meet with her in secret. She happens to be trying to escape from her employer's grasp as well, and she mentions how her older brother has been trying to help her escape. You mention how you’re trying to escape as well, and you live in a village close to her's in the Tharu Community.
  ...
  {  //count 14
    text: `You decide to put up with being a kamlari for a few more years. You feel this is the best choice to help your parents’ financial situation, but you’ll still have to put up with unbearable working hours and treatment.
...
,
  ...
  {  //count 15
    text:  `You decide to attend the charity’s school in order to continue your interrupted education. Many of the other students were also rescued kamlari. Together you are able to continue your study of reading and writing and make up the schooling you lost when sent away as a kamlari.
 It turns out that your master is too scared to punish you with worse abuse out of fear from receiving a lawsuit. You do, though, still have to do your daily work in the house but for less hours than before. This life continues for about two more years until you are finally freed from being a kamlari for good! Upon arriving home, you are granted a scholarship by a non-governmental organization called Room to Read and are back to being enrolled in school. You become a member of Room to Read’s Girls’ Education Program and are able to pick back up on your literary skills. The Girls’ Education Program has supported about 5,000 girls in Nepal alone and is given in other countries as well. Being a child laborer was a major roadblock in your educational path, but you were able to overcome it and are now far less likely to live in impoverished conditions in the future.`
 ,
    b1: "",
    b2: "",
    b3: "Start Over"
